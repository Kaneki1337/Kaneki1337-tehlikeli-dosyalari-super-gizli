...
class spotify:
    ...
    def register_account(self):
        ...
        data = f"birth_day=1&birth_month=01&birth_year=1970&collect_personal_info=undefined&creation_flow=&creation_point=https://www.spotify.com/uk/&displayname=Kaneki1337&email={email}&gender=neutral&iagree=1&key=a1e486e2729f46d6bb368d6b2bcda326&password={password}&password_repeat={password}&platform=www&referrer=&send-email=1&thirdpartyemail=0&fb=0"
        try:
    ...
    def follow(self):
        ...
        if login_token == None:
            return None, "cok hizli yapiyon dur"
        elif login_token == False:
            return None, f"proxy bok gibi {self.proxy}"
        auth_token = self.get_token(login_token)
        if auth_token == None:
            return None, "while token alinamad"
        headers = {
            "accept": "application/json",
            "Accept-Encoding": "gzip, deflate, br",
            "accept-language": "en",
        ...
        try:
            ...
            return False, "while takib edi"

#Developed by https://github.com/Kaneki1337
